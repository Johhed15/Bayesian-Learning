...
for (i in 2:n_samp){
  ...
  beta_samples[i,] <- dmvnorm(betas,rowMeans(mw),Vw)
...
```{r}
# theta is vector of model parameters for which posterior density is evaluated, must be first argument
...
RWMSampler <- function(theta, logPostFunc, C, Sigma, its){
